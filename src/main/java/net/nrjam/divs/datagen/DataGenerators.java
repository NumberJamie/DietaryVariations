package net.nrjam.divs.datagen;
...
import net.nrjam.divs.datagen.tags.ModBlockTags;
import net.nrjam.divs.datagen.tags.ModItemTags;

import java.util.concurrent.CompletableFuture;

@Mod.EventBusSubscriber(modid = DietaryVariations.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
